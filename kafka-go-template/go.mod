...
require (
	...
	github.com/ecodia/golang-awaitility v0.0.0-20180710094957-fb55e59708c7 // indirect
	...
	github.com/testcontainers/testcontainers-go/modules/compose v0.17.0 // indirect
